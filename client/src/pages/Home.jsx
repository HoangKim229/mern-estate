...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* listing results for offer, sale, rent and buy */}
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
        ...
        {saleListings && saleListings.length > 0 && (
         ...
         {buyListings && buyListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              <h2 className='text-2xl font-semibold text-slate-600'>Recent places for buy</h2>
              <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=buy'}>Show more places for buy</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
